...
from app.domain.tourist.slots import DEFAULT_SLOT_VALUES, REQUIRED_SLOTS, SLOT_QUESTION
from app.domain.tourist.summary import build_tourist_summary_text
